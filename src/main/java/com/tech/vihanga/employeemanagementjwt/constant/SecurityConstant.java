...
public class SecurityConstant {
    public static final long EXPIRATION_TIME = 432000000;//5 days in miliseconsds
    ...
    public static final String[] publicURL = {"/user/login", "/user/register", "/user/rest/password/**", "/user/image/**"};
}
